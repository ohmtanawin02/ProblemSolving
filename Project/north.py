...
while again == 'Y' or again == 'y': #loop while เพื่อเลือกเงื่อนไข
    ...
    if key == 1: #ไม่แวะ
        ...
        print('Shorttest path from ',location1 ,'to',location2 ,'is',nx.shortest_path(G,source=location1,target=location2,weight='weight'))
    ...
    if key == 2: #แวะ1จุด
        ...
        c=(nx.shortest_path_length(G,source=location1,target=location3,weight='weight'))
        d=(nx.shortest_path(G,source=location1,target=location2,weight='weight'))
        e=(nx.shortest_path(G,source=location3,target=location2,weight='weight'))
        f=(nx.shortest_path(G,source=location1,target=location3,weight='weight'))
        A=(nx.shortest_path(G,source=location2,target=location3,weight='weight'))
        if a+c <= a+b:
          g=(f+e)
          h=c+b
